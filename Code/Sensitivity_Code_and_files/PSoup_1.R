...
loaded_obj_names <- load("/g/data/vw43/cm9768/HPsim/16384/param_values_all_Incr_1_part1.RData")
...
allSim <- setupSims(folder, maxStep = 200, delay = 20, exogenousSupply = FALSE, combinatorial = FALSE, preventDrop = TRUE,nCores = 46, reduceSize = TRUE)
...
combined_data <- data.frame(Hormones = Hormones, Gene = Gene)

# Specify the file path for the RData file
file_path_combined <- "/g/data/vw43/cm9768/HPsim/16384/Results_Sobol_first_run.RData"
