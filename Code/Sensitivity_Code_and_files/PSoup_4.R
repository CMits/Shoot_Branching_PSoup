...
loaded_obj_names <- load("/g/data/vw43/cm9768/HPsim/16384/param_values_all_Incr_1_part4.RData")
...
allSim <- setupSims(folder, maxStep = 200, delay = 20, exogenousSupply = FALSE, combinatorial = FALSE, preventDrop = TRUE,nCores = 24, reduceSize = TRUE)
...
file_path_combined <- "/g/data/vw43/cm9768/HPsim/16384/Results_Sobol_fourth_run.RData"
